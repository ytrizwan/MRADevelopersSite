						...
						<nav aria-label="Page navigation example text-center">
							<ul class="pagination justify-content-center">
								...
								<li class="page-item <?php if($page == 1){ echo " disabled ";} ?>">
									<a class="page-link" href="search.php?page=<?php echo "1"; ?>" aria-label="First">
								...
								<li 
									...
									<?php 
									echo "<a class=\"page-link\" href='search.php?page=".$i."'>";
									echo $i;
									echo "</a> ";
									?>
								</li>		
								...
								<li class="page-item <?php if($page == $total_pages){ echo " disabled ";} ?>">		
									<a class="page-link" href="search.php?page=<?php echo $total_pages; ?>" aria-label="Last">
