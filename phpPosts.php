		...
		<div class="container mainContainer marginTopByFive">
			<div class="row text-center">
				<div class="col-lg-8 col-12">
					...
					$sql = "SELECT COUNT(ID) AS total FROM ".$datatable." WHERE cat = 'p';"; 
						...
						<nav aria-label="Page navigation example text-center">
							<ul class="pagination justify-content-center">
								...
								<li class="page-item <?php if($page == 1){ echo " disabled ";} ?>">
									<a class="page-link" href="phpPosts.php?page=<?php echo "1"; ?>" aria-label="First">
								...
								<li class="page-item <?php if($page == 1){ echo " disabled ";} ?>">
									<a class="page-link" href="phpPosts.php?page=<?php echo $page-1; ?>" aria-label="Previous">
								...
								<li 
									...
									<?php 
									echo "<a class=\"page-link\" href='phpPosts.php?page=".$i."'>";
									echo $i;
									echo "</a> ";
									?>
								</li>		
								...
								<li class="page-item <?php if($page == $total_pages){ echo " disabled ";} ?>">		
									<a class="page-link" href="phpPosts.php?page=<?php echo $page+1; ?>" aria-label="Next">
								...
								<li class="page-item <?php if($page == $total_pages){ echo " disabled ";} ?>">		
									<a class="page-link" href="phpPosts.php?page=<?php echo $total_pages; ?>" aria-label="Last">
